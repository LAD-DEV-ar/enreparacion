            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    ...
                    <button
                        ...
                        class="h-16 rounded-2xl bg-primary px-8 text-lg font-bold text-white transition-all hover:bg-primary-hover active:scale-[0.98] shadow-md flex items-center gap-2.5 cursor-pointer shrink-0 w-full lg:w-auto"
                    >
