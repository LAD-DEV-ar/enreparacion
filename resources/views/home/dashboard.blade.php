        ...
        >
            ...
            >
                ...
                <div class="flex items-center justify-end gap-4 pt-5 mt-2 border-t border-border/20">
                    <a :href="`/reparaciones?selectedReparacion=${selectedReparacion?.id}`" class="flex items-center gap-2 justify-center h-11 rounded-xl bg-warning/80 hover:bg-warning px-6 text-sm font-bold text-white transition-all cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
